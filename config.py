...
def get_template_context() -> dict:
    ...
    return {
        ...
        "admin_provider_help": "Pegá un link de producto de So Chic para crear el artículo con fotos, precio y disponibilidad por encargo.",
        "admin_provider_url_label": "Link del producto",
        "admin_provider_url_placeholder": "https://sochic.com.ar/product/...",
        "admin_provider_btn": "Importar So Chic",
        "admin_provider_importing": "Importando producto...",
        "admin_provider_created": "Producto importado correctamente.",
